...
public class MainController {
    ...
    private JPanel crearPanelBusqueda(JInternalFrame internal) {
        ...
        btnMostrarTodos.addActionListener(e -> mostrarTodosUsuarios(internal));
    ...
    private JPanel crearPanelResultados(JInternalFrame internal) {
        ...
        // btnEliminar.addActionListener(e -> eliminarUsuarioSeleccionado(internal, table)); // Removed
    ...
    private JPanel crearPanelBotonesEdicionBibliotecario(JDialog dialog, JInternalFrame internal, 
        ...
        btnGuardar.addActionListener(e -> guardarCambiosBibliotecario(dialog, internal, userId, fieldsPanel));
        btnCancelar.addActionListener(e -> dialog.dispose());
